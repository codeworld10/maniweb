  ...
  return (
    <div>
      <p className="priv">
        ...
        other intellectual property rights related to it, still belong to Usman
        mani.
        <p>
          Muhammad Usman is committed to ensuring that the app is as useful and
          ...
          The Global Worker app stores and processes personal data that you have
          ...
          security features and it could mean that the Global Worker app won’t
          work properly or at all. The app does use third-party services that
          ...
          AdMob Expo You should be aware that there are certain things that
          Muhammad Usman will not take responsibility for. Certain functions of the
          ...
          but Muhammad Usman cannot take responsibility for the app not working at
          full functionality if you don’t have access to Wi-Fi, and you don’t
          have any of your data allowance left. If you’re using the app outside
          of an area with Wi-Fi, you should remember that the terms of the
          ...
          for using the app. Along the same lines, Muhammad Usman cannot always take
          ...
          can’t turn it on to avail the Service, Muhammad Usman cannot accept
          responsibility. With respect to Muhammad Usman’s responsibility for your
          ...
          information to us so that we can make it available to you. Muhammad Usman
          ...
          keep using the app. Muhammad Usman does not promise that it will always
        ...
        <p>
        Before hiring a worker make sure the worker know about your task. This platform only make it easy for people to find work and worker in area. We are not compnay we are non-profit 
        we do not give jobs. People in your area will give you the job. We are not responsible for any damage or loss. We are not responsible for any kind of fraud.
        </p>
...
These terms and conditions are effective as of 2022-08-08
        ...
        <h2>Contact us</h2>
        <p>
        If you have any questions or suggestions about my Terms and Conditions, do not hesitate to contact me at globalworkerhelp@gmail.com.
        </p>
      </p>
    </div>
  );
