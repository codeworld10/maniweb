  ...
  return (
    <div>
      <p className="priv">
        ...
        mani.
        <p>
          Usman mani is committed to ensuring that the app is as useful and
          ...
          Usman mani will not take responsibility for. Certain functions of the
          ...
          but Usman mani cannot take responsibility for the app not working at
          ...
          for using the app. Along the same lines, Usman mani cannot always take
          ...
          can’t turn it on to avail the Service, Usman mani cannot accept
          responsibility. With respect to Usman mani’s responsibility for your
          ...
          information to us so that we can make it available to you. Usman mani
          ...
          keep using the app. Usman mani does not promise that it will always
